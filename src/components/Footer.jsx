...
import { SOCIAL_LINKS, getWhatsAppUrl } from '../config';
import './Footer.css';
                ...
                <div className="footer-main">
                    ...
                    <div className="footer-column footer-brand-section">
                        ...
                        <div className="footer-credentials">
                            ...
                            <div className="credential-badge">
                                <span className="badge-icon">★</span>
                                <span>300+ Clients Transformed</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="footer-column footer-newsletter">
                        ...
                        <div className="footer-social-section">
                            ...
                            <p className="footer-instagram-cta">Follow us on Instagram for wellness tips &amp; updates.</p>
                            <div className="social-links">
                                ...
                                <a href={getWhatsAppUrl()} className="social-link" aria-label="WhatsApp" target="_blank" rel="noopener noreferrer">
                                    <svg viewBox="0 0 24 24" fill="currentColor">
                ...
                <div className="footer-bottom">
                    <div className="footer-bottom-content">
                        <p className="footer-copyright">
                            © {currentYear} NutriVigor. All rights reserved.
                        </p>
                        <div className="footer-bottom-links">
                            <a href="#privacy">Privacy Policy</a>
                            <a href="#terms">Terms of Service</a>
                            <ScrollLink to="consultation" smooth={true} duration={800} offset={-80}>Contact</ScrollLink>
                        </div>
                    </div>
                </div>
            </div>
